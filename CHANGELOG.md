...
- Changed the default behaviour of SnRecordPicker to close on select when multiple is used. Can be overriden to stay open by setting the prop *closeOnSelectMultiple* to false
